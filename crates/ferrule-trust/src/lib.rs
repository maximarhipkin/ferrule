...
//! destructive shell commands, answered in the owner's chat (Telegram,
//! Discord, Slack) or at the terminal; plan mode; and an audit log of all
//! of it. The agent loop sees only
