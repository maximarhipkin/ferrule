...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-610-8a929a" alt="610 workspace tests">
</p>
...
```bash
cargo test --workspace                     # 610 tests on Linux; macOS and Windows cfg out the platform-only ones
